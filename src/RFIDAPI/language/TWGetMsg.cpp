...
CErrorStruct errorTWMsg[] = 
{
	...
	{ERR_NOT_CONNECT,L"埠未打開"},
	{ERR_READING_NOTEXE,L"讀卡狀態中不可執行的指令"},
	{ERR_COMMAND_EXEING,L"指令在執行當中"},
	...
	{ERR_UDPRECV_SOCKETERROR,L"UDP發送資料時socket出錯"},
	{ERR_UDPRECV_SOCKETOVERTIME,L"UDP發送資料超時" },
