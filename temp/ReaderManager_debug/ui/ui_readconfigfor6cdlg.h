/********************************************************************************
** Form generated from reading UI file 'readconfigfor6cdlg.ui'
**
...
#ifndef UI_READCONFIGFOR6CDLG_H
#define UI_READCONFIGFOR6CDLG_H
...
public:
    ...
    void setupUi(QWidget *ReadConfigFor6CDlg)
    {
        if (ReadConfigFor6CDlg->objectName().isEmpty())
            ReadConfigFor6CDlg->setObjectName(QStringLiteral("ReadConfigFor6CDlg"));
        ReadConfigFor6CDlg->resize(528, 302);
        gridLayout_4 = new QGridLayout(ReadConfigFor6CDlg);
        gridLayout_4->setSpacing(0);
        gridLayout_4->setObjectName(QStringLiteral("gridLayout_4"));
        gridLayout_4->setContentsMargins(0, 0, 0, 0);
        frame = new QFrame(ReadConfigFor6CDlg);
...
"}"));
        ...
        gridLayout->addWidget(widget_9, 0, 0, 3, 1);
...
"}"));
        ...
        gridLayout->addWidget(widget_15, 2, 1, 1, 1);


        gridLayout_4->addWidget(frame, 0, 0, 1, 1);


        retranslateUi(ReadConfigFor6CDlg);

        QMetaObject::connectSlotsByName(ReadConfigFor6CDlg);
    } // setupUi

    void retranslateUi(QWidget *ReadConfigFor6CDlg)
    {
        ReadConfigFor6CDlg->setWindowTitle(QApplication::translate("ReadConfigFor6CDlg", "Form", Q_NULLPTR));
        label_16->setText(QApplication::translate("ReadConfigFor6CDlg", "\345\244\251\347\272\277\350\256\276\347\275\256", Q_NULLPTR));
        label_18->setText(QApplication::translate("ReadConfigFor6CDlg", "\345\260\204\351\242\221\350\256\276\347\275\256", Q_NULLPTR));
        label_17->setText(QApplication::translate("ReadConfigFor6CDlg", "\350\275\275\346\263\242\350\256\276\347\275\256", Q_NULLPTR));
        label_19->setText(QApplication::translate("ReadConfigFor6CDlg", "\350\257\273\345\215\241\345\243\260\351\237\263", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ReadConfigFor6CDlg: public Ui_ReadConfigFor6CDlg {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_READCONFIGFOR6CDLG_H
